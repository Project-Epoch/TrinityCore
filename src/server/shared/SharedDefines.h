...
// EnumUtils: DESCRIBE THIS
enum SpellDmgClassMask
{
    SPELL_DAMAGE_CLASS_MASK_NONE    = (1 << SPELL_DAMAGE_CLASS_NONE),
    SPELL_DAMAGE_CLASS_MASK_MAGIC   = (1 << SPELL_DAMAGE_CLASS_MAGIC),
    SPELL_DAMAGE_CLASS_MASK_MELEE   = (1 << SPELL_DAMAGE_CLASS_MELEE),
    SPELL_DAMAGE_CLASS_MASK_RANGED  = (1 << SPELL_DAMAGE_CLASS_RANGED)
};
