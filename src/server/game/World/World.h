...
enum WorldFloatConfigs : uint32
{
    ...
    CONFIG_RESPAWN_DYNAMIC_RANGE,
    CONFIG_RESPAWN_DYNAMIC_PERCENT_PER_PLAYER,
    CONFIG_RESPAWN_DYNAMIC_MAX_REDUCTION_RATE,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_RESPAWN_DYNAMIC_PLAYER_THRESHOLD,
    CONFIG_RESPAWN_DYNAMIC_PLAYER_MAX_LEVEL_DIFF,
    CONFIG_RESPAWN_DYNAMIC_MIN_RESPAWN_TIME,
